        ...
        <>
          ...
          <div className="mobile-drawer">
            <div className="mobile-drawer__header">
              ...
              <button className="mobile-drawer__close" onClick={() => setMobileMenuOpen(false)} aria-label="Close menu">✕</button>
            </div>
            <div className="mobile-drawer__links">
              ...
              <button className="mobile-drawer__link" onClick={() => scrollToSection('stack')}>
                <span className="mobile-drawer__icon">⚡</span> Tech Stash
              </button>
              <button className="mobile-drawer__link" onClick={() => scrollToSection('achievements')}>
                <span className="mobile-drawer__icon">🏆</span> Hall of Fame
              </button>
              <button className="mobile-drawer__link" onClick={() => scrollToSection('contact')}>
                <span className="mobile-drawer__icon">🤝</span> Get In Touch
              </button>
            </div>
            <div className="mobile-drawer__footer">
              <a href={GITHUB_URL} target="_blank" rel="noreferrer" className="mobile-drawer__social">
